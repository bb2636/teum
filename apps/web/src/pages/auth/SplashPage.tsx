...
export function SplashPage() {
  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col items-center justify-between px-6 max-w-md mx-auto w-full">
        ...
        <div className="w-full pb-6 space-y-4">
          ...
          <div className="flex justify-center items-center gap-5">
            ...
            <button
              ...
              className="w-12 h-12 rounded-full bg-black flex items-center justify-center hover:bg-gray-800 transition-colors shadow-sm"
